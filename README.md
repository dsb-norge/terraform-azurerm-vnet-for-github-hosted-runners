...
| <a name="input_key_vault_pe_description_tag"></a> [key\_vault\_pe\_description\_tag](#input\_key\_vault\_pe\_description\_tag) | Custom description for key vault private endpoints.<br/>This will be used as the 'Description' tag for each key vault private endpoint.<br/>Max length: 250 characters. | `string` | `""` | no |
