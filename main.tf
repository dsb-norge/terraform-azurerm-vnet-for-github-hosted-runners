...
module "gh_runner_vnet" {
  ...
  location            = var.location
  resource_group_name = azurerm_resource_group.this.name
  address_space       = compact(concat([var.network_specs.address_space], tolist(var.network_specs.additional_pe_subnet)))
  ...
  subnets = {
    ...
    pe_subnet = {
      ...
      address_prefixes = compact(concat([var.network_specs.address_space], tolist(var.network_specs.additional_pe_subnet)))
